...
using ReservationSystem.Areas.Admin.Controllers;
using Microsoft.AspNetCore.Identity;

namespace ReservationSystem.Controllers
{
    public class SittingController : AdminController
    {
        private readonly ISittingRepository _sittingRepository;
        private readonly ApplicationDbContext context;

        public SittingController(ISittingRepository sittingRepository, ApplicationDbContext context, RoleManager<IdentityRole> roleManager, UserManager<IdentityUser> userManager) : base(roleManager, userManager)
        {
        ...
        { 
            ...
            var sittings =  _sittingRepository.GetSittingWithType().Where(s=>s.Start>DateTime.Now).ToList();
