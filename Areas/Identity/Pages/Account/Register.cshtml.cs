...
namespace ReservationSystem.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            //Add additional properties for registering
            [Required]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    else
                    {
                        ...
                        var customer = new Customer { Email = user.Email,FirstName=Input.FirstName,LastName=Input.LastName,PhoneNumber=Input.Phone };
