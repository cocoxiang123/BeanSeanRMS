...
namespace ReservationSystem.Data.Migrations
{
    ...
    [Migration("20200516095541_addtablesAndStatus")]
    partial class addtablesAndStatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReservationSystem.Models.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ReservationSystem.Models.Restaurant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("T4RMSSolution.Models.ReservationStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("T4RMSSolution.Models.Table", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ReservationSystem.Models.Reservation", b =>
                {
                    b.HasOne("ReservationSystem.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("T4RMSSolution.Models.ReservationStatus", "Status")
                        .WithMany()
                    ...
                    b.HasOne("T4RMSSolution.Models.Table", "Table")
                        .WithMany()
